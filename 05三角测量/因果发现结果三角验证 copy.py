...
class EvidenceTriangulation:
    ...
    def __init__(self, base_dir="/home/zkr/因果发现"):
        ...
        self.methods = [
            'PC算法', 'ExpertInLoop_LLM', 'Chow-Liu', 'TAN',
            'HillClimbing_AIC-D', 'HillClimbing_BDS', 'HillClimbing_BIC-D', 'HillClimbing_K2',
            'GreedyEquivalence_AIC-D', 'GreedyEquivalence_BDEU', 'GreedyEquivalence_BDS', 
            'GreedyEquivalence_BIC-D', 'GreedyEquivalence_K2'
        ]
